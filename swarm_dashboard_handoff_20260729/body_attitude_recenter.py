    ...
    def from_environment(cls) -> "BodyAttitudeRecenterConfig":
        ...
        return cls(
            ...
            deadband_deg=_env_float(
                ...
                _env_float(
                    "SWARM_BODY_RECENTER_DEADBAND_DEG", 1.0, 0.2, 10.0
                ),
                0.2,
                10.0,
            ),
            enter_deadband_deg=_env_float(
                "SWARM_BODY_RECENTER_ENTER_DEG", 3.0, 0.4, 15.0
            ),
            filter_time_constant_s=_env_float(
                "SWARM_BODY_RECENTER_FILTER_TAU_S", 0.30, 0.02, 2.0
            ),
            enter_hold_s=_env_float(
                "SWARM_BODY_RECENTER_ENTER_HOLD_S", 0.08, 0.0, 0.5
            ),
            ...
            bbox_yaw_gain=_env_float(
                "SWARM_BODY_BBOX_YAW_GAIN", 1.80, 0.0, 3.0
            ),
            yaw_fast_threshold_deg=_env_float(
                "SWARM_BODY_YAW_FAST_THRESHOLD_DEG", 5.0, 1.0, 20.0
            ),
            yaw_fast_min_rate_deg_s=_env_float(
                "SWARM_BODY_YAW_FAST_MIN_RATE_DEG_S", 18.0, 2.0, 45.0
            ),
            yaw_fast_kp=_env_float(
                "SWARM_BODY_YAW_FAST_KP", 2.4, 0.0, 8.0
            ),
            roll_kp=_env_float(
            ...
            yaw_kp=_env_float(
                "SWARM_BODY_RECENTER_YAW_KP", 0.75, 0.0, 3.0
            ),
            yaw_kp_far=_env_float(
                "SWARM_BODY_RECENTER_YAW_KP_FAR", 1.20, 0.0, 3.0
            ),
            ...
            max_yaw_rate_deg_s=_env_float(
                "SWARM_BODY_RECENTER_MAX_YAW_RATE_DEG_S", 45.0, 1.0, 45.0
            ),
            ...
            rate_slew_deg_s2=_env_float(
                "SWARM_BODY_RECENTER_RATE_SLEW_DEG_S2", 180.0, 1.0, 180.0
            ),
...
class BodyAttitudeRecenterController:
    ...
    def update(
        ...
        *,
        ...
        if yaw_error_abs >= cfg.yaw_fast_threshold_deg:
